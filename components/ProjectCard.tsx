    ...
    return (
        <div>
            ...
            <p className="my-2 text-center">{ name }</p>
            {
                ...
                <div className="absolute top-[50%] left-0 z-10 grid w-[1000px] m-auto h-auto p-2 rounded-lg md:p-10 bg-gray-100 mtext-black md:grid-cols-2 gap-x-12 dark:text-white dark:bg-dark-100">
